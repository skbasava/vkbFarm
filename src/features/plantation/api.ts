...
export type PlantationSummary = { areas: FarmArea[]; rows: Array<{ cropId: string; cropName: string; quantities: Record<string, number>; totalQuantity: number }>; areaTotals: Record<string, number>; totalQuantity: number };
